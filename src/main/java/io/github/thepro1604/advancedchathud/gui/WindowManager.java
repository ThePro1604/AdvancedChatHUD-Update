...
import io.github.thepro1604.advancedchathud.config.gui.ChatWindowEditor;
...
public class WindowManager implements IRenderer, ResolutionEventHandler {
    ...
    private void renderStyleHoverEffect(GuiGraphicsExtractor drawContext, Style style, int x, int y) {
        io.github.thepro1604.advancedchatcore.util.ChatHudHelper.renderHoverTooltip(drawContext, style, x, y);
    }
